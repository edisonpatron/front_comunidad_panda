<template>
    <div class="px-4 py-8 md:px-6 lg:px-8">
        ...
        <div class="mt-6 mb-5 font-bold text-6xl text-900 text-center">Página restringida</div>
        <p class="text-700 text-3xl mt-0 mb-6 text-center">Lo sentimos, no tienes acceso a esta página.</p>
    </div>
</template>
