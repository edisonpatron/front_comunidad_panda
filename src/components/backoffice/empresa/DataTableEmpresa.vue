...
const apiURL = BackofficeUrls.custom(RESOURCESBACKOFFICE.Empresas, '/pv');
        ...
        command: (event) => {
          confirm.require({
            ...
            accept: () => {
              ...
              http.delete(BackofficeUrls.delete(RESOURCESBACKOFFICE.Empresas, recordClicked.value.id), {}).then((response) => {
...
const updateRecord = (data) => {
  http.put(BackofficeUrls.put(RESOURCESBACKOFFICE.Empresas, data.id), {estado: data.estado}, {}).then((response) => {
